...
namespace JenSaneFourPoint.Items
{
    ...
    public class ExampleSimpleMinionBuff : ModBuff
    {
        public override void SetStaticDefaults()
        {
            ...
            Description.SetDefault("The crow minion will fight for you");
    ...
    public class ExampleSimpleMinionItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Crow Summon Item");
            Tooltip.SetDefault("Summons a crow to fight for you. The crow's damage increases with plague doctor damage.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.DamageType = ModContent.GetInstance<PlagueDoctorDamageClass>(); // Makes the damage register as summon. If your item does not have any damage type, it becomes true damage (which means that damage scalars will not affect it). Be sure to have a damage type
    ...
    public class ExampleSimpleMinion : ModProjectile
    {
        ...
        public sealed override void SetDefaults()
        {
            ...
            Projectile.DamageType = ModContent.GetInstance<PlagueDoctorDamageClass>(); // Declares the damage type (needed for it to deal damage)
