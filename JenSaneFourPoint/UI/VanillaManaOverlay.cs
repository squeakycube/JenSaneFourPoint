...
namespace JenSaneFourPoint.UI
{
    internal class ExampleResourceBar : UIState
    {
        ...
        public bool ShowPotUI;

        public override void OnInitialize()
        {
            //var textpot = Main.LocalPlayer.GetModPlayer<PlagueReal>(); //GetItemNameValue(ItemID.HiveBackpack)
           ...
           // var modPlayer = Main.LocalPlayer.GetModPlayer<PlagueReal>();
          //  if (modPlayer.MedBagEquipped = true)
          //  {
                barFrame.Left.Set(22, 0f);
          //  }
          //  else
          //  {
          //      barFrame.Left.Set(222, 0f);
          //  }
                barFrame.Top.Set(0, 0f);
                barFrame.Width.Set(138, 0f);
                barFrame.Height.Set(34, 0f);
            //barFrame.Opacity.Set(100);

            //Plague p = player.GetModPlayer<Plague>();
            //  p.Potency;

            //  var modPlayer = Main.LocalPlayer.GetModPlayer<Plague>();
            ...
            text = new UIText("0|0"); // text to show stat
                                      //text = new UIText("Plague Potency", modPlayer.Potency, 1); // text to show stat
