...
namespace JenSaneFourPoint.NPCs
{
    ...
    public class LunaticPlagueDoctor : ModNPC
    {
        ...
        public static int MinionCount()
        {
            ...
            if (Main.expertMode)
            {
                count += 4; // Increase by 5 if expert or master mode
            }

            if (Main.getGoodWorld)
            {
                count += 4; // Increase by 5 if using the "For The Worthy" seed
            }
        ...
        {
            DisplayName.SetDefault("Lunatic Plague Doctor");
            ...
            if (!Main.dedServ)
            {
                Music = MusicLoader.GetMusicSlot(Mod, "SFX/Music/RainingBodies");
            }
        }
        ...
        public override void ScaleExpertStats(int numPlayers, float bossLifeScale)
        {
            ...
            NPC.lifeMax = (int)(NPC.lifeMax * 1.95f);
        }
        ...
        public int RandNpc = Main.rand.Next(8);
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < count; i++)
                {
                    //    if (NPCSpawnType >= 1)
                    int index = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), ModContent.NPCType<ThomasMini>(), NPC.whoAmI);
                    int npc2 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), ModContent.NPCType<ResurrectedBird>(), NPC.whoAmI);
                    int npc3 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), ModContent.NPCType<Crow>(), NPC.whoAmI); //NPCID.Zombie
                                                                                                                                                                                 //         int npc4 = NPC.NewNPC(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, NPCID.Zombie, NPC.whoAmI);
                    int npc5 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.CursedSkull, NPC.whoAmI);
                    int npc6 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.DarkCaster, NPC.whoAmI);
                    //         int npc7 = NPC.NewNPC(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, NPCID.Eyezor, NPC.whoAmI);
              //      int npc8 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.FloatyGross, NPC.whoAmI);
                    //         int npc9 = NPC.NewNPC(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, NPCID.Frankenstein, NPC.whoAmI);
              //      int npc10 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.Ghost, NPC.whoAmI);
              //      int npc11 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.Poltergeist, NPC.whoAmI);
                    // int npc12 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.Reaper, NPC.whoAmI);
                    // int npc13 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.RuneWizard, NPC.whoAmI);
                    int npc15 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.SkeletonSniper, NPC.whoAmI);
                    int npc16 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.TacticalSkeleton, NPC.whoAmI);
                    int npc17 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.GiantCursedSkull, NPC.whoAmI);
                  //  int npc18 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.Wraith, NPC.whoAmI);
                //    int npc19 = NPC.NewNPC(entitySource, (int)NPC.Center.X + Main.rand.Next(20), (int)NPC.Center.Y + Main.rand.Next(20), NPCID.Ghost, NPC.whoAmI);
                    ...
                    NPC spawnMinion2 = Main.npc[npc2];
                    NPC spawnMinion3 = Main.npc[npc3];
                    //     NPC spawnMinion4 = Main.npc[npc4];
                    NPC spawnMinion5 = Main.npc[npc5];
                    NPC spawnMinion6 = Main.npc[npc6];
                    // NPC spawnMinion7 = Main.npc[npc7];
               //     NPC spawnMinion8 = Main.npc[npc8];
                    //    NPC spawnMinion9 = Main.npc[npc9];
                  //  NPC spawnMinion10 = Main.npc[npc10];
                  //  NPC spawnMinion11 = Main.npc[npc11];
                    //     NPC spawnMinion12 = Main.npc[npc12];
                    //     NPC spawnMinion13 = Main.npc[npc13];
                    // NPC spawnMinion14 = Main.npc[npc14];
                    NPC spawnMinion15 = Main.npc[npc15];
                    NPC spawnMinion16 = Main.npc[npc16];
                    NPC spawnMinion17 = Main.npc[npc17];
                //    NPC spawnMinion18 = Main.npc[npc18];
                //    NPC spawnMinion19 = Main.npc[npc19];
                    //        }
        ...
        public int NPCSpawnType = Main.rand.Next(2);
                    ...
                    case 2:
                        {
                            ...
                            Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, 20f * boltVel, Mod.Find<ModProjectile>("PlagueSkull").Type, 122, Main.myPlayer, NPC.target);
                    ...
                    case 3:
                        {//HallowBossRainbowStreak
                            ...
                            if (Main.netMode == NetmodeID.MultiplayerClient)
                            {
                                ...
                                float math = MathHelper.TwoPi / 9 * (NPC.ai[1]);
                                Vector2 boltVel = -Vector2.UnitY.RotatedBy(-math);
                                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, 20f * boltVel, Mod.Find<ModProjectile>("PlagueSkull").Type, Main.myPlayer, NPC.target);
                            ...
                            //var entitySource = NPC.GetSource_FromAI(); //ResurrectedBird

                            for (int i = 0; i < 15; i++)
                                if (Main.rand.Next(50) == 1)
                                {
                                    {
                                        int index = NPC.NewNPC(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<ResurrectedBird>(), NPC.whoAmI);
                                        NPC minionNPC = Main.npc[index];
                                    }
        ...
        {
            return ModContent.NPCType<ResurrectedBird>();
        }
