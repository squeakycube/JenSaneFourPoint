...
public class ThomasMini : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Thick Crow -w-");
                    ...
                    case 2:
                        {
                            if (Main.rand.Next(3) == 1)
                            {
                                ...
                                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, 20f * boltVel, Mod.Find<ModProjectile>("PlagueSkull").Type, 82, Main.myPlayer, NPC.target);
                    ...
                    case 3:
                        {//HallowBossRainbowStreak
                            ...
                            if (Main.netMode == NetmodeID.MultiplayerClient)
                            {
                                ...
                                float math = MathHelper.TwoPi / 9 * (NPC.ai[1]);
                                Vector2 boltVel = -Vector2.UnitY.RotatedBy(-math);
                                Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, 10f * boltVel, Mod.Find<ModProjectile>("PlagueSkull").Type, 22, Main.myPlayer, NPC.target);
