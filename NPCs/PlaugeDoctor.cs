...
namespace JenSaneFourPoint.NPCs //PlaugeDoctor
{
    [AutoloadHead]
    class PlaugeDoctor : ModNPC //
    {
        ...
        {
            bool travelerIsThere = (NPC.FindFirstNPC(ModContent.NPCType<PlaugeDoctor>()) != -1); // Find a Merchant if there's one spawned in the world
            ...
            {
                int newTraveler = NPC.NewNPC(Terraria.Entity.GetSource_TownSpawn(), Main.spawnTileX * 16, Main.spawnTileY * 16, ModContent.NPCType<PlaugeDoctor>(), 1); // Spawning at the world spawn
        ...
        {
            return new PlaugeDoctorProfile();
        }
    ...
    public class PlaugeDoctorProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("JenSaneFourPoint/NPCs/PlaugeDoctor");
        ...
        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("JenSaneFourPoint/NPCs/PlaugeDoctor_Head");
    }
}